 ...
 * Date: 12. April 2018
 * Description:
 * Battery Management System abstraction. Each object corresponds to one
 * low-powered BMS unit. Each unit is identified by a unique ID, which is also
 * used to infer IDs of CAN messages.
 *
...
constexpr uint16_t kIdBase =
    300;  // Base for ids of CAN messages related to BMS
