...
int main(int argc, char* argv[]) {
  ...
  while (sys.running_) {
    ...
    switch (sm.current_state) {
      case State::kIdle:
        if (sens.module_status == ModuleStatus::kInit &&
            *navs.status == ModuleStatus::kInit) {
    ...
    log_system.INFO("TST_SEN", "IMUs online: %d,%d,%d,%d",
                    !!imus[0].operational, !!imus[1].operational,
                    !!imus[2].operational, !!imus[3].operational);
    ...
    log_system.INFO(
        "TST_SEN", "Proxi-front online: %3d,%3d,%3d,%3d,%3d,%3d,%3d,%3d",
    ...
    log_system.INFO(
        "TST_SEN", "Proxi-front data:   %3d,%3d,%3d,%3d,%3d,%3d,%3d,%3d",
        proxis_front[0].val, proxis_front[1].val, proxis_front[2].val,
        proxis_front[3].val, proxis_front[4].val, proxis_front[5].val,
        proxis_front[6].val, proxis_front[7].val);

    auto proxis_back = sens.proxi_back.value;
    log_system.INFO("TST_SEN",
                    "Proxi-back online: %3d,%3d,%3d,%3d,%3d,%3d,%3d,%3d",
    ...
    log_system.INFO("TST_SEN",
                    "Proxi-back data:   %3d,%3d,%3d,%3d,%3d,%3d,%3d,%3d",
                    proxis_back[0].val, proxis_back[1].val, proxis_back[2].val,
                    proxis_back[3].val, proxis_back[4].val, proxis_back[5].val,
                    proxis_back[6].val, proxis_back[7].val);
#endif
    ...
    log_system.INFO("TST_NAV", "status = %d, is_calibrating = %d", *navs.status,
                    *navs.is_calibrating);
    log_system.INFO(
        "TST_NAV",
        "After %7d grav samples, g=[(%8.4f %8.4f %8.4f), (%8.4f %8.4f %8.4f), "
        "(%8.4f %8.4f %8.4f), (%8.4f %8.4f %8.4f)]",
        *navs.num_gravity_samples, (*navs.g)[0][0], (*navs.g)[0][1],
        (*navs.g)[0][2], (*navs.g)[1][0], (*navs.g)[1][1], (*navs.g)[1][2],
        (*navs.g)[2][0], (*navs.g)[2][1], (*navs.g)[2][2], (*navs.g)[3][0],
        (*navs.g)[3][1], (*navs.g)[3][2]);
    log_system.INFO("TST_NAV",
                    "After %7d gyro samples: gyro_offsets=[(%8.4f %8.4f "
                    "%8.4f), (%8.4f %8.4f %8.4f), "
                    "(%8.4f %8.4f %8.4f), (%8.4f %8.4f %8.4f)]",
                    *navs.num_gyro_samples, (*navs.gyro_offsets)[0][0],
                    (*navs.gyro_offsets)[0][1], (*navs.gyro_offsets)[0][2],
                    (*navs.gyro_offsets)[1][0], (*navs.gyro_offsets)[1][1],
                    (*navs.gyro_offsets)[1][2], (*navs.gyro_offsets)[2][0],
                    (*navs.gyro_offsets)[2][1], (*navs.gyro_offsets)[2][2],
                    (*navs.gyro_offsets)[3][0], (*navs.gyro_offsets)[3][1],
                    (*navs.gyro_offsets)[3][2]);
    log_system.INFO("TST_NAV",
                    "Outputs: a=(%8.4f %8.4f %8.4f), v=(%8.4f %8.4f %8.4f), "
                    "d=(%10.4f %10.4f %10.4f)",
                    (*navs.acceleration)[0], (*navs.acceleration)[1],
                    (*navs.acceleration)[2], (*navs.velocity)[0],
                    (*navs.velocity)[1], (*navs.velocity)[2],
                    (*navs.displacement)[0], (*navs.displacement)[1],
                    (*navs.displacement)[2]);
    log_system.INFO("TST_NAV",
                    "         orientation=(%7.4f, %7.4f, %7.4f, %7.4f)",
                    (*navs.orientation)[0], (*navs.orientation)[1],
                    (*navs.orientation)[2], (*navs.orientation)[3]);
    log_system.INFO(
        "TST_NAV",
        "stripe count = %2d, braking d = %8.2f, emergency braking d = %8.2f",
