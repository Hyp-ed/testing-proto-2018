...
public:
  ...
  struct Settings {
    ...
    float prox_orient_w =
        0.1; ///< Weight (from [0,1]) of proxi vs imu in orientation calculation
...
private:
  ...
  void
  gyroUpdate(DataPoint<NavigationVector> angular_velocity); // Point number 1
  ...
  void
  opticalEncoderUpdate(array<float, Sensors::kNumOptEnc> optical_enc_distance);
