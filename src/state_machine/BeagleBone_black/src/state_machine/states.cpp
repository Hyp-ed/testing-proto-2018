...
void Idle::entry() { state_ = state::kIdle; }
...
void Calibrating::entry() { state_ = state::kCalibrating; }
...
void Ready::entry() { state_ = state::kReady; }
...
void Accelerating::entry() { state_ = state::kAccelerating; }
...
void Decelerating::entry() { state_ = state::kDecelerating; }
...
void RunComplete::entry() { state_ = state::kRunComplete; }
...
void Exiting::entry() { state_ = state::kExiting; }
...
void Finished::entry() { state_ = state::kFinished; }
