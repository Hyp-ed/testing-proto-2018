...
void printUsage() {
  printf("./hyped [args]\n");
  printf(
      "All arguments are optional. To provide an argument with a value, use "
      "<argument>=<value>.\n"
      "Default value of verbose flags is 1\n"
      "Default value of debug   flags is 0\n"
      "\n  -v, --verbose[=<bool>]\n"
      "    Set system-wide setting of verbosity. If enabled, prints all INFO "
      "messages\n"
      ...
      "INFO messages\n"
      "\n  -d, --debug[=<level>]\n"
      "    Set system-wide debug level. All DBG[n] where n <= level messages "
      "are printed.\n"
      "\n  --debug_motor, --debug_nav, --debug_sensor, --debug_state, "
      "--debug_cmn\n"
      "    Set module-specific debug level. All DBG[n] where n <= level "
      "messages are printed.\n"
      "\n  --fake_imu --fake_proxi --fake_motors --fake_sensors --fake_keyence "
      "--fake_batteries\n"
